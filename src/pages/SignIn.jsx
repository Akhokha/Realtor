...
function onChange(e){
  ...
  SetFormData ((prevState)=>({
    ...prevState,
    [e.target.id]:e.target.value, // id = input form id (id='email')
  })) 
}
  return (
    <section>
      <p className='text-3xl text-center mt-6 font-bold'>Sign In</p>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form >
            ...
            />
            {
              showPassword? 
              <AiFillEyeInvisible 
              className="absolute right-3 top-3 text-ex cursor-pointer"
